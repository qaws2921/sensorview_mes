...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            {name: 'plan_no3', index: 'plan_no3', key:true,sortable: false, width: 90},
            {name: 'part_name', index: 'part_name',sortable: false, width: 60},
            {name: 'part_name1', index: 'part_name1',sortable: false, width: 80},
            {name: 'part_name2', index: 'part_name2',sortable: false, width: 80},
            {name: 'part_length', index: 'part_length',sortable: false, width: 40},
            {name: 'unit_name', index: 'unit_name',sortable: false, width: 40},
            {name: 'plan_qty', index: 'plan_qty',sortable: false, width: 40},
            {name: 'work_qty', index: 'work_qty',sortable: false, width: 40},
            {name: 'plan_date', index: 'plan_date',sortable: false, width: 60, formatter: formmatterDate2},
            {name: 'prod_type_name', index: 'prod_type_name',sortable: false, width: 50},
            {name: 'prod_dept_name', index: 'prod_dept_name',sortable: false, width: 50},
            {name: 'part_grp_name', index: 'part_grp_name',sortable: false, width: 70},
            {name: 'part_grp_name2', index: 'part_grp_name2',sortable: false, width: 70},
            {name: 'user_name', index: 'user_name',sortable: false, width: 40},
            {name: 'work_user_name', index: 'work_user_name',sortable: false, width: 40},
            ...
            {name: 'remark', index: 'remark',sortable: false, width: 70},
            {name: 'remark1', index: 'remark1',sortable: false, width: 70}
        ],
