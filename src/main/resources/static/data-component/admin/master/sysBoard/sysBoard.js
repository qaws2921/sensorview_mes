...
function jqGrid_main() {
    ...
    $('#mes_grid').jqGrid({
        ...
        colModel:[
            {name:'board_code',index:'board_code',key: true ,sortable: false,width:60},
            {name:'board_en',index:'board_en',sortable: false,width:60},
            {name:'board_kr',index:'board_kr',sortable: false,width:60},
            {name:'board_auth_name',index:'board_auth_name',sortable: false,width:60},
            {name:'board_auth',index:'board_auth',sortable: false,hidden:true, width:60},
            {name:'files',index:'files',sortable: false,width:60},
            {name:'file_size',index:'file_size',sortable: false,width:60},
