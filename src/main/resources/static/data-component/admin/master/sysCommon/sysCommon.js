...
function jqGrid_main() {
    ...
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'code_value', index: 'code_value',key:true,sortable: false, width: 60},
            ...
            {name: 'code_name5', index: 'code_name5',sortable: false, width: 60},
            {name: 'code_name6', index: 'code_name6',sortable: false, width: 60},
            {name: 'code_name7', index: 'code_name7',sortable: false, width: 60},
