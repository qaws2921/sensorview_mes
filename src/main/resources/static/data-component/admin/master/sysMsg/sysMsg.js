...
function jqGrid_main() {
	...
	$('#mes_grid').jqGrid({
		...
		colModel:[
			{name:'msg_code',index:'msg_code',key: true ,sortable: false,width:60},
			{name:'msg_name1',index:'msg_name1',sortable: false,width:60},
			{name:'msg_name2',index:'msg_name2',sortable: false,width:60},
			{name:'msg_name3',index:'msg_name3',sortable: false,width:60},
			{name:'msg_name4',index:'msg_name4',sortable: false,width:60},
