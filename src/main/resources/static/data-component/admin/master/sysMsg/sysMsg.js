...
function jqGrid_main() {
	...
	$('#mes_grid').jqGrid({
		...
		colModel:[
			{name:'msg_code',index:'msg_code',key: true ,sortable: false,width:50},
			{name:'msg_name1',index:'msg_name1',sortable: false,width:100},
			{name:'msg_name2',index:'msg_name2',sortable: false,width:100},
			{name:'msg_name3',index:'msg_name3',sortable: false,width:100},
			{name:'msg_name4',index:'msg_name4',sortable: false,width:100},
			{name:'user_code',index:'user_code',sortable: false,width:40},
			{name:'create_date',index:'create_date',formatter:formmatterDate,sortable: false,width:60},
			{name:'update_date',index:'update_date',formatter:formmatterDate,sortable: false,width:60},
		],
		caption: "메세지관리 | MES",
		autowidth: true,
		height: 600,
