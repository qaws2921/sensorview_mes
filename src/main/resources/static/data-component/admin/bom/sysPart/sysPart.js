...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        datatype: "local",
        mtype: 'POST',
        colNames: ['품번','품명','규격1','규격2','재질','제조사','공급사','용도','자재유형','품목군','제품군','보관로케이션','단위','L/T','검사등급','재고최대','재고최소','등록자','수정일'],
        colModel: [
            {name: 'part_code', index: 'part_code', key:true, sortable: false, width: 60},
            {name: 'part_name', index: 'part_name', sortable: false, width: 60},
            {name: 'spec1', index: 'spec1', sortable: false, width: 60},
            {name: 'spec2', index: 'spec2', sortable: false, width: 60},
            {name: 'material', index: 'material', sortable: false, width: 60},
            {name: 'maker_name', index: 'maker_name', sortable: false, width: 60},
            {name: 'supp_name', index: 'supp_name', sortable: false, width: 60},
            {name: 'prod_type_name', index: 'prod_type_name', sortable: false, width: 60},
            {name: 'material_type_name', index: 'material_type_name', sortable: false, width: 60},
            ...
            {name: 'max_qty', index: 'max_qty', sortable: false, width: 40},
            {name: 'min_qty', index: 'min_qty', sortable: false, width: 40},
