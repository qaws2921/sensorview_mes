            ...
            <table class="table wt-100 ">
                ...
                <tr>
                    ...
                    <td colspan="3" style="border: 0px !important;;">
                        <input type="text" name="item_code" class="form-control h-25 modal_value2"/>
                    </td>
                </tr>
                <tr>
                    <td class="wt-px-100 t-align-c td-title padding-a-0" style="border: 0px !important;">세부내용</td>
                    <td colspan="3" style="border: 0px !important;;">
                        <input type="text" name="item_name" class="form-control h-25 modal_value2"/>
                    </td>
                </tr>
                <tr>
                    <td class="wt-px-100 t-align-c td-title padding-a-0" style="border: 0px !important;">적용값</td>
                    <td colspan="3" style="border: 0px !important;;">
                        <input type="text" name="item_value" class="form-control h-25 modal_value2"/>
                    </td>
                </tr>
                </tbody>
            </table>
