...
<div id="addDialog" title="생산계획(ASSY)등록" style="display:none">
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" class="form-control h-25 modal_value" name="part_length" onkeyup="num_keyup(this)">
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="remark" class="form-control modal_value" name="remark">
            </div>
            <div class="profile-info-name">비고</div>
            <div class="profile-info-value">
                <input type="text" name="remark1" class="form-control modal_value" name="remark1">
            </div>
        </div>
    </div>
</div>
