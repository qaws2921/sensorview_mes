...
<script type="text/javascript" src="/data-component/mesPOP/Pop/popPlanASSY/popPlanASSY.js" charset="UTF-8"></script>
        ...
        <div class="col-lg-12 padding0">
            <table class="table wt-100">
                ...
                <tr>
                    ...
                    <td class="wt-px-200">
                        <select class="form-control condition_main" style="width:100%">
                        </select>
                    </td>
...
<%@include file="popPlanASSY_modal1.jsp" %>
