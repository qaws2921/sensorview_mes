...
<div id="addDialog" title="생산계획(SUB)등록" style="display:none">
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" class="form-control modal_value" id="line_name_modal1" name="line_name1" readonly>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" class="form-control modal_value" name="remark1">
            </div>
