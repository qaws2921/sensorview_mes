...
<script type="text/javascript" src="/data-component/mesPOP/Pop/popPlan3/popPlan3.js" charset="UTF-8"></script>
        ...
        <div class="col-lg-12 padding0">
            <table class="table wt-100">
                ...
                <tr>
                    ...
                    <td class="wt-px-200">
                        <select class="form-control condition_main" name="keyword4" id="part_name_select" style="width:100%">
                        </select>
                    </td>
                    <td class="wt-px-100 t-align-c td-title padding-a-0">공정</td>
                    <td class="wt-px-200">
                        <select class="form-control condition_main" id="line_select" name="keyword5" style="width:100%">
                        </select>
                    </td>
                    <td></td>
                </tr>
