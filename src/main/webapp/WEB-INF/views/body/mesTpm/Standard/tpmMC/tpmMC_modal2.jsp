    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="part_name" class="form-control modal_value2">
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="spec" class="form-control modal_value2">
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="qty" class="form-control modal_value2">
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="buy_corp_name" class="form-control modal_value2">
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="corp_tel_no" class="form-control modal_value2">
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="remark" class="form-control modal_value2">
            </div>
        </div>
