...
<div id="addDialog" title="사후보전관리 추가" style="display:none">
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input name="error_name" type="text" class="form-control keyword modal_value" style="width: 100%">
            </div>
        </div>
        <div class="profile-info-row">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="measure_name" class="form-control keyword modal_value" style="width: 100%">
            </div>
        </div>
