    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="supp_code" class="form-control modal_value"/>
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="ceo" class="form-control modal_value" />
            </div>
            <div class="profile-info-name">업체명(영문)</div>
            <div class="profile-info-value">
                <input type="text" name="supp_name_en" class="form-control modal_value"/>
            </div>
        </div>
        <div class="profile-info-row">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="buss_type" class="form-control modal_value" />
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="category" class="form-control modal_value" />
            </div>
            <div class="profile-info-name">결재방법</div>
            <div class="profile-info-value">
                <input type="text" name="give_type" class="form-control modal_value"/>
            </div>
        </div>
    </div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="address" class="form-control modal_value" />
            </div>
        </div>
    </div>
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="emp_email" class="form-control modal_value" />
            </div>
