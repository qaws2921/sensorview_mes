...
<script type="text/javascript" src="/data-component/admin/master/sysCommon/sysCommon_modal1.js"
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="group_name" id="group_name" class="form-control modal_value" readonly/>
                <input type="hidden" name="group_code" id="group_code" class="form-control modal_value" />
            </div>
            <div class="profile-info-name"> 코드</div>
            <div class="profile-info-value">
                <input type="text" name="code_value" class="form-control modal_value"/>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="code_name5" class="form-control modal_value"/>
            </div>
            <div class="profile-info-name"> 명칭6</div>
            <div class="profile-info-value">
                <input type="text" name="code_name6" class="form-control modal_value"/>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="code_name7" class="form-control modal_value"/>
            </div>
            <div class="profile-info-name"> 명칭8</div>
            <div class="profile-info-value">
                <input type="text" name="code_name8" class="form-control modal_value"/>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <select name="use_yn" class="form-control keyword modal_value">
