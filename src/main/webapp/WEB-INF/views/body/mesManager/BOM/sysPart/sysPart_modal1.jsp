...
<div id="addDialog" title="품목정보 추가" style="display:none">
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" id="spec1" name="spec1" class="form-control modal_value">
            </div>
            <div class="profile-info-name">규격2</div>
            <div class="profile-info-value">
                <input type="text" id="spec2" name="spec2" class="form-control modal_value">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" id="material" name="material" class="form-control modal_value" >
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" name="lt" class="form-control modal_value">
            </div>
