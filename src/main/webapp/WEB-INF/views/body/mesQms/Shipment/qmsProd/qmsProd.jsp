...
<%@ page session="false" %>
<script type="text/javascript" src="/data-component/mesQMS/Shipment/qmsProd/qmsProd.js" charset="UTF-8"></script>
...
<%@include file="qmsProd_modal1.jsp"%>
<%@include file="qmsProd_modal2.jsp"%>
