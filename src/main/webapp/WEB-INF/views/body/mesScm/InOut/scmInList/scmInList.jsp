    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table id="scmInListGrid"></table>
                <div id="scmInListGridPager"></div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="col-lg-12 padding0">
            <table class="table wt-100">
                ...
                <tr>
                    <td class="wt-px-100">
                        <select class="form-control h-25 select2">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var grid_selector = "#scmInListGrid";
        var pager_selector = "#scmInListGridPager";
