...
<script type="text/javascript" src="/data-component/mesSCM/InOut/scmOutOrder/scmOutOrder.js" charset="UTF-8"></script>
        ...
        <div class="col-lg-12 padding0">
            <table class="table wt-100">
                ...
                <tr>
                    ...
                    <td class="wt-px-200">
                        <select name="keyword" id="qc_select" class="form-control h-25 condition_main" id="scmOutOrderSelect">
