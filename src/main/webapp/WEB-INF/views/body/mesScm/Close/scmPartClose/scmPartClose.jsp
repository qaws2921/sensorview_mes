                ...
                <tr>
                    ...
                    <td class="wt-px-200">
                        <div class="input-icon input-icon-right">
                            <input type="text" name="keyword" id="datepicker" class="form-control h-25 condition_main" readonly>
                    ...
                    <td class="wt-px-200">
                        <div class="input-icon input-icon-right">
                            ...
                            <input type="hidden" name="keyword2" class="form-control h-25 condition_main"
                                   id="supp_code_main">
                    ...
                    <td class="wt-px-200">
                        <input type="text" name="keyword3" id="remark" class="form-control h-25 t-align-c condition_main" />
                    </td>
                    <td></td>
                </tr>
                </tbody>
