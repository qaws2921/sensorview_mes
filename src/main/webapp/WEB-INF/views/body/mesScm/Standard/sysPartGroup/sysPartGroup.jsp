...
<script type="text/javascript" src="/data-component/mesSCM/Standard/sysPartGroup/sysPartGroup.js" charset="UTF-8"></script>
        ...
        <div class="col-lg-12 padding0">
            <table class="table wt-100">
                ...
                <tr>
                    ...
                    <td class="wt-px-100 t-align-c td-title padding-a-0">관리항목</td>
                    <td class="wt-px-200">
                        <select name="keyword2" id="part_group_select" class="form-control keyword condition_main" style="width:100%">
                            <option value="">전체</option>
                        </select>
                    </td>
                    <td></td>
