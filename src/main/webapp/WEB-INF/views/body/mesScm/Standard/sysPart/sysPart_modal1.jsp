...
<script type="text/javascript" src="/data-component/mesSCM/Standard/sysPart/sysPart_modal1.js"
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" id="part_type_name" class="form-control modal_value" readonly>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" class="form-control modal_value" readonly placeholder="자동생성">
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <select id="loc_select" name="loc_code" class="form-control keyword modal_value" style="width:100%">
                    <option val="">선택안함</option>
                </select>
            </div>
            <div class="profile-info-name">L/T</div>
            <div class="profile-info-value">
                <input type="text" id="LT" class="form-control modal_value" onchange="inputIntChangeLT();">
            </div>
        </div>
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <input type="text" id="supp_name_main" class="form-control modal_value" readonly>
            </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <select id="unit_select" name="unit_name" class="form-control keyword modal_value" style="width:100%">
                    <option val="">선택안함</option>
                </select>
            </div>
        </div>
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <select id="qc_select" name="qc_level" class="form-control keyword modal_value" style="width:100%">
                    <option val="">선택안함</option>
                    <option val="0">무검사</option>
                    <option val="1">샘플검사</option>
                    <option val="2">전수검사</option>
                </select>
            </div>
            <div class="profile-info-name">재고최대</div>
            <div class="profile-info-value">
                <input type="text" id="max_qty" class="form-control modal_value" onchange="inputIntChangeMaxQty();">
            </div>
        </div>
        <div class="profile-info-row">
            <div class="profile-info-name">재고최소</div>
            <div class="profile-info-value">
                <input type="text" id="min_qty" class="form-control modal_value" onchange="inputIntChangeMinQty();">
            </div>
            <div class="profile-info-name">발주단위</div>
            <div class="profile-info-value">
                <input type="text" id="ord_qty" class="form-control modal_value" onchange="inputIntChangeOrdQty();">
            </div>
        </div>
    </div>
</div>
