                ...
                <div class="col-xs-8 ">
                    <table class="table multi_table">
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <input type="text" class="form-control main_value" name="delivery_addr">
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-xs-8">
                    <table class="table multi_table">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <input type="text" name="qty" id="qty" class="form-control main_value crm_order_value" onkeyup="sum_qty_keyup();">
                            </td>
                            <td class="wt-px-100 td-title t-align-c">길이단위</td>
                            <td class="wt-px-200">
                                <select class="form-control main_value crm_order_select" id="length_type" name="length_type" style="width: 100%;">
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <input type="text" class="form-control main_value crm_order_value" name="remark">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <input type="text" id="unit_price" name="unit_price" class="form-control main_value crm_order_value"  onkeyup="sum_qty_keyup();">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <input type="text" name="sample" id="sample" class="form-control main_value crm_order_value" >
                            </td>
                        </tr>
                        <tr>
