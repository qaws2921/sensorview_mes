                ...
                <div class="col-lg-6">
                    ...
                    <table class="table multi_table">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="status2_select" name="status2">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="part_type_select" onchange="select_change1(this.value);" name="part_type">
                                </select>
                            </td>
                        ...
                        <tr>
                            <td class="wt-px-100 td-title t-align-c">
                                <label for="chk1" class="td-title" style="font-size: 11px"> 단품 </label>&nbsp;<input
                                    type="radio" name="work_type" class="main_value" value="1" id="chk1" checked onclick="radio1_btn();">
                            </td>
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="part_select" name="part_code">
                        ...
                        <tr>
                            <td class="wt-px-100 td-title t-align-c">
                                <label for="chk2" class="td-title" style="font-size: 11px"> 조립 </label>&nbsp;<input
                                    type="radio" value="2" name="work_type" class="main_value" id="chk2"  onclick="radio2_btn();">
                            </td>
                            <td class="wt-px-200">
                                <input type="text" name="connector1" class="form-control main_value" readonly>
                            </td>
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="part_select2" name="part_code2">

                                </select>
                            </td>
                            <td class="wt-px-200">
                                <input type="text" name="connector2" class="form-control main_value" readonly>
                            </td>
                            <td class="wt-px-100 td-title t-align-c">개별길이(M)</td>
                            <td class="wt-px-200">
                                <input type="text" name="part_length" class="form-control main_value" readonly>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tube" class="form-control main_value">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5" class="t-align-c">
                                ...
                                <input type="checkbox" name="option3" id="chbox3" value="N" class="main_value">
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table multi_table">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="crm_type_select" name="crm_type">
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="delivery_select" name="delivery">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="sale_type_select" name="sale_type">
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="price_type_select" name="price_type">
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="delivery_corp_select" name="delivery_corp">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="delivery_price_select" name="delivery_price">
                        ...
                        <tr>
                            ...
                            <td class="wt-px-200">
                                <select class="form-control main_value" id="currency_select" name="currency_type">
