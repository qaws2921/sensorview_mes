...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        mtype: 'POST',
        datatype: "local",
        colNames: ['제품유형','품목군','제품군','품목코드','품목명','규격','단위','전월재고','금월입고','금월출고','재고'],
        colModel: [
            {name: 'part_type_name', index: 'part_type_name', width: 60},
            {name: 'part_grp_name', index: 'part_type_name', width: 60},
            {name: 'part_grp_name2', index: 'part_type_name', width: 60},
            {name: 'part_code', index: 'part_grp_name1', width: 60},
