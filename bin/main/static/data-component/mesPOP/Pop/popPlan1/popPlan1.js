...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        datatype: "local",
        mtype: 'POST',
        colNames: ['등록번호','status','현황','제품명','계획량','생산량','작업구분','생산구분','품목군','part_grp_code','제품군','part_grp_code2','part_code','등록자','등록일','마감일','Remark','비고','계획일'],
        colModel: [
            {name: 'plan_no1', index: 'plan_no1',key:true,sortable: false, width: 70},
            ...
            {name: 'part_grp_code', index: 'part_grp_name1',sortable: false,hidden:true, width: 60},
            ...
            {name: 'plan_date', index: 'plan_date',sortable: false,hidden:true, width: 60,formatter: formmatterDate2}
        ],
